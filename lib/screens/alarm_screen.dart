        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Action Buttons
              if (alarmService.currentState.isTriggered)
                ElevatedButton(
                ...
                ElevatedButton(
                  onPressed: () => alarmService.deactivate(),
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 20),
                ...
                ElevatedButton(
                  onPressed: () => alarmService.activate(mode: _selectedMode),
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 20),
